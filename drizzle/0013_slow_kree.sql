...
INSERT INTO `__new_short_goals`("id", "goal", "description", "icon_category", "date", "completed", "is_reminder", "notification_id", "reminder_datetime", "created_at", "updated_at") SELECT "id", "goal", "description", "icon_category", "date", "completed", "is_reminder", "notification_id", "reminder_datetime", "created_at", "updated_at" FROM `short_goals`;--> statement-breakpoint
